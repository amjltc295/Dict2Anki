...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.syncBtn.setText(_translate("Dialog", "開始同步"))
        self.deckLabel.setText(_translate("Dialog", "牌組"))
        self.label.setText(_translate("Dialog", "新單詞"))
        self.label_2.setText(_translate("Dialog", "待刪除"))
        self.apiLabel.setText(_translate("Dialog", "查詢"))
        self.dictionaryLabel.setText(_translate("Dialog", "詞典"))
        self.pullRemoteWordsBtn.setText(_translate("Dialog", "獲取單詞"))
        ...
        self.defaultConfigGroupBox.setTitle(_translate("Dialog", "默認設置"))
        self.sentenceCheckBox.setText(_translate("Dialog", "例句"))
        self.definitionCheckBox.setText(_translate("Dialog", "釋義"))
        self.noPronRadioButton.setText(_translate("Dialog", "無發音"))
        self.phraseCheckBox.setText(_translate("Dialog", "短語"))
        self.BrEPronRadioButton.setText(_translate("Dialog", "英式發音"))
        self.AmEPronRadioButton.setText(_translate("Dialog", "美式發音"))
        self.BrEPhoneticCheckBox.setText(_translate("Dialog", "英式英標"))
        self.AmEPhoneticCheckBox.setText(_translate("Dialog", "美式英標"))
        self.imageCheckBox.setText(_translate("Dialog", "圖片"))
        self.credentialGroupBox.setTitle(_translate("Dialog", "賬號設置"))
        self.currentDictionaryLabel.setText(_translate("Dialog", "當前選擇詞典: "))
        self.usernameLabel.setText(_translate("Dialog", "賬號"))
        self.passwordLabel.setText(_translate("Dialog", "密碼"))
        self.cookieLabel.setText(_translate("Dialog", "Cookie"))
        self.cookieLineEdit.setPlaceholderText(_translate("Dialog", "選填"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.settingTab), _translate("Dialog", "設置"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.logTab), _translate("Dialog", "日誌"))
